...
class AudioService {
  ...
  static String? _lastFastPathArtFile;
  static String? _lastFastPathMediaId;
  ...
  static Future<void> _observeMediaItem() async {
    ...
    _handler.mediaItem.listen((mediaItem) async {
      ...
      if (artUri == null || artUri.scheme == 'content') {
        _lastFastPathArtFile = null;
        _lastFastPathMediaId = null;
        _platform
            .setMediaItem(
        ...
        if (artUri.scheme == 'file') {
          final filePath = artUri.toFilePath();
          if (filePath == _lastFastPathArtFile &&
              mediaItem.id == _lastFastPathMediaId) {
            sendToPlatform(filePath).catchError(_asyncError.add);
            return;
          }
          _lastFastPathArtFile = filePath;
          _lastFastPathMediaId = mediaItem.id;
          sendToPlatform(filePath).catchError(_asyncError.add);
        } else {
